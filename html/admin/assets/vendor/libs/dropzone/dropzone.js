                        ...
                        return function() {
                            ...
                            return function() {
                                ...
                                var u = {
                                    ...
                                    renameFile: null,
                                    forceFallback: !1,
                                    dictDefaultMessage: "Thả file vào đây để upload",
                                    dictFallbackMessage: "Trình duyệt của bạn không hỗ trợ kéo và thả file tải lên.",
                                    dictFallbackText: "Vui lòng sử dụng biểu mẫu dự phòng bên dưới để tải tệp của bạn lên như ngày xưa.",
                                    dictFileTooBig: "Tệp quá lớn ({{filesize}}MiB). Kích thước tệp tối đa: {{maxFilesize}}MiB.",
                                    dictInvalidFileType: "Bạn không thể tải lên các tệp thuộc loại này.",
                                    dictResponseError: "Máy chủ phản hồi bằng mã {{statusCode}} .",
                                    dictCancelUpload: "Hủy tải lên",
                                    dictUploadCanceled: "Đã hủy tải lên.",
                                    dictCancelUploadConfirmation: "Bạn có chắc chắn muốn hủy việc tải lên này không?",
                                    dictRemoveFile: "Xóa File",
                                    dictRemoveFileConfirmation: null,
                                    dictMaxFilesExceeded: "Bạn không thể tải lên bất kỳ tập tin nào nữa.",
