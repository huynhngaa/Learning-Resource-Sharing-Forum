                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <ul class="nav nav-pills flex-column flex-md-row mb-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="DoiMK_NguoiDung.php?this_username=<?php echo $row_nguoi_dung['nd_username']?>&vt=<?php echo $row_nguoi_dung['vt_ma']?>"><i class=" fa fa-lock me-1"></i>
                                    Mật khẩu</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="BaiViet_NguoiDung.php?this_username=<?php echo $row_nguoi_dung['nd_username']?>&vt=<?php echo $row_nguoi_dung['vt_ma']?>"><i class="fa fa-file-text" aria-hidden="true"></i> Bài viết</a>
                            </li>
                                        ...
                                        <form id="formAccountSettings" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label for="lastName" class="form-label">Họ tên</label><span style="color: red;font-weight: bold;"> *</span>
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label for="firstName" class="form-label">Username</label><span style="color: red;font-weight: bold;"> *</span>
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label for="email" class="form-label">Vai trò</label><span style="color: red;font-weight: bold;"> *</span>
