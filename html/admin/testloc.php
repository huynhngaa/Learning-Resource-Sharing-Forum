            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <h5 style="padding: 1.5rem 0 0 1.5rem" class="card-header">Danh sách <?php echo $row_vai_tro['vt_ten']?></h5>
...
<div class="col-lg-6 col-md-6 mt-2">
                                ...
                                <div class="col-lg-2 col-sm-2 col-4">
                                    <form method="POST">
                                        ...
                                        <button
                                            class="col-lg-4  col-sm-4 col-5 dt-button buttons-collection dropdown-toggle btn btn-label-secondary ms-sm-0 me-3"
                                            type="button"><span>
                                        ...
                                        <button class="col-lg-5  col-sm-5 col-2 dt-button add-new btn btn-primary" type="button"
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sort-header">Họ tên
                                                <button id="asc" type="submit" class="small-button" data-sort="asc"><i
                                                        class="fa fa-sort-asc"></i></button>
                                                <button id="desc" type="submit" class="small-button" data-sort="desc"><i
                                    ...
                                    <tbody class="table-border-bottom-0" id="data-container">
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: normal"><?php echo  $row_nguoi_dung['nd_hoten']; ?>
                                            </td>
                                            <!-- <td>
                                                <ul
