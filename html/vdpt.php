...
<body>
                                                       ...
                                                       <div class="tab-content">
                                                            <nav aria-label="breadcrumb">
                                                                 <ol class="breadcrumb breadcrumb-style1">
                                                                      ...
                                                                      <li class="breadcrumb-item active"><?php echo 'Lịch sử bình luận' ?></li>
                                                                 </ol>
                                                            </nav>
    ...
    <div class="card-body d-flex justify-content-between">
        <div class="form-check ">
            <input class="form-check-input check-item" name="check[]" type="checkbox" value="106">
...
<button class="btn btn-danger"><i class="fa-regular fa-trash-can"></i></button> 
                                                                                ...
                                                                                <?php
                                                                                $username = $_GET['id'];
                                                                                $nguoi_dung = "SELECT DISTINCT a.nd_username as chunhan , b.*, c.nd_hoten ,r.bl_cha, CURRENT_TIMESTAMP()
                                                                                FROM binh_luan b
                                                                                ...
                                                                                if (mysqli_num_rows($result_nguoi_dung) > 0) {
                                                                                     foreach ($grouped_articles as $date => $articles) {
                                                                                          ...
                                                                                          foreach ($articles as $key => $article) {
                                                                                                   ...
                                                                                                   echo '<div class="col-lg-1 mb-sm-0">';
                                                                                                   echo'<input class="form-check-input check-item" name="check[]" type="checkbox" value="106">';
                                                                                                   echo '</div>';
