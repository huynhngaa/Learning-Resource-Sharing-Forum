...
// include "include/head.php";
    ...
    if (!empty($topResults)) {
        $stt =0;
        echo '<h5 class ="ps-3"> Bài viết liên quan </h5>';
...
?>
                          ...
                          <a target="_blank" href="chitietbv.php?id=<?php echo $row['bv_ma'] ?>" class="list-group-item list-group-item-action"> <b><?php echo $stt . '. '  . $row['bv_tieude'].'</b>' ?></a>
